...
def main():
    ...
    s3_info_text = ('The "Game of Life" by John Conway. \n'
                    ...
                    'Key p or middle mouse button - toggle pattern mode. \n'
                    ...
                    'You also have the option to create/delete patterns and select them from the inventory '
                    '(the last opened pattern is used) in the top-right corner (key i). \n'
